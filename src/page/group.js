    ...
    return (
        <div>
            ...
            <div className="md:m-4 m-2" style={{ clear: 'both' }}>
                <h1 className="md:text-5xl text-2xl dark:text-white" style={{ fontFamily: 'NanumSquareNeo-Variable', fontWeight: 'bold' }}>DEVELOPER'S CHOICE✨</h1>
                <h5 className="md:mt-4 mt-2 md:text-2xl text-xl dark:text-white" style={{ fontFamily: 'LINESeedKR-Bd' }}>멜로톡 개발자가 직접 고른 그룹들입니다.</h5>
            </div>
        </div>
    );
}
